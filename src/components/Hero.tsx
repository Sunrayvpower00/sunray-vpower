        ...
        >
          ...
          >
            ...
            <a
              ...
              className="w-full rounded-xl border border-green-500 px-6 py-4 font-semibold text-green-400 transition duration-300 hover:scale-105 hover:bg-green-500 hover:text-white sm:w-auto sm:px-8"
            >
...
Thank you.`
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-orange-500 to-yellow-500 px-4 py-3.5 text-sm font-bold tracking-wide text-white transition-all duration-300 hover:scale-105 sm:mt-8 sm:py-4 sm:text-base"
            >
              ENQUIRE NOW
            </a>
          </div>
