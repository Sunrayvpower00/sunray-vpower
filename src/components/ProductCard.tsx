...
export default function ProductCard({
  ...
  const imageSrc = image.startsWith("/sunray-vpower")
    ? image
    : `/sunray-vpower${image}`;
    ...
    <div className="group overflow-hidden rounded-3xl border border-orange-500/20 bg-white/5 backdrop-blur-lg transition-all duration-500 hover:-translate-y-2 hover:border-orange-500 hover:shadow-[0_0_40px_rgba(249,115,22,0.35)]">
      ...
      <div className="space-y-3 p-6">
        ...
        <div className="space-y-2 text-gray-300">
          ...
          <p>
            <span className="font-semibold text-orange-400">Warranty:</span>{" "}
            {warranty}
          </p>

          <p>
            <span className="font-semibold text-orange-400">MRP:</span>{" "}
            {mrp}
          </p>
        </div>
...
Please share today's best price and availability.`
          ...
          className="mt-8 flex w-full items-center justify-center gap-3 rounded-xl bg-green-600 py-4 text-lg font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-green-700"
        >
